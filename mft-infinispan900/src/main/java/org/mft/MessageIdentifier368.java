...
public class MessageIdentifier368 {
   ...
   public static List<MessageId> getMessageIdentifiers(List<Message> msgList) {
      MessageId[] ids = new MessageId[msgList.size()];
      int i = 0;
      for (Message msg : msgList) {
         ids[i++] = (Identifier.Header) msg.getHeader(Identifier.PROTOCOL_ID);
      }
